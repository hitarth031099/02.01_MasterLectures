...
public abstract class TreatmentDto {
	...
	public enum TreatmentType {
		@SerializedName(SURGERY_TAG)
		SURGERY, @SerializedName(DRUGTREATMENT_TAG)
		DRUGTREATMENT, @SerializedName(RADIOLOGY_TAG)
		RADIOLOGY, @SerializedName(PHYSIOTHERAPY_TAG)
		PHYSIOTHERAPY;
		...
		public static boolean isValid(String value) {
			return SURGERY_TAG.equals(value) || DRUGTREATMENT_TAG.equals(value) || RADIOLOGY_TAG.equals(value)
					|| PHYSIOTHERAPY_TAG.equals(value);
		}
	}
	...
	public void setDrug(String asString) {
	}

	public void setDosage(float asFloat) {
	}

	public void setStartDate(LocalDate parse) {
	}

	public void setEndDate(LocalDate parse) {
	}

	public void setFrequency(int asInt) {
	}

	public void setSurgeryDate(LocalDate parse) {
	}

	public void setDischargeInstruction(String asString) {
	}

	public void setFollowups(UUID[] array) {
	}

	public void setTreatmentDateList(LocalDate[] array) {
	}
