...
public class Provider implements Serializable, ITreatmentImporter {
	...
	@OneToMany(targetEntity = Treatment.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	...
	@Override
	public Consumer<Treatment> importDrug(UUID tid, Patient patient, Provider provider, String diagnosis, String drug,
